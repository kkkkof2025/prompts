...
$files = @(
    ...
    "examples/trace-observability/trace-otel-sdk-multilang.md",
    "docs/ai-history-community-ecosystem.md",
    "docs/seven-layer-ai-civilization.md",
    "docs/native-multi-role-simulation.md",
    "docs/openclaw-multi-agent-linkage.md",
    "docs/openclaw-superbrain-architecture.md",
    "docs/chapters/13-safety-governance.md",
    "docs/chapters/14-practice-plan.md",
    "docs/chapters/15-career-development.md",
    "docs/capstone-projects.md",
    "docs/community-continuous-learning.md",
    "docs/model-cost-calculator.md",
    ...
    "docs/cases/career-transition-cases.md",
    "docs/cases/career-development.md",
    "docs/cases/ai-short-drama-production.md",
    ...
    "docs/prompt-templates-library.md",
    ...
    "docs/prompt-optimization-savings.md",
    "docs/api-integration-patterns.md",
    "docs/data-preparation-guide.md",
    "docs/when-not-to-use-ai.md",
    "docs/first-day-with-ai.md",
    "docs/30day-tracking-sheet.md",
    "docs/chapter-graded-exercises.md",
    "docs/role-based-quickstart.md",
    ...
    "docs/appendix-career-resources.md",
