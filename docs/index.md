...
<p class="hero-title">AI 学习方法全景书</p>
...
重点读 [第 5 章](chapters/05-evaluation.md)、[第 6 章](chapters/06-tools-rag.md)、[第 7 章](chapters/07-skills.md)。
</div>

<div class="route-card" markdown="1">
**想理解 agent**

重点读 [第 8 章](chapters/08-agents.md)、[第 9 章](chapters/09-memory.md)、[第 10 章](chapters/10-openclaw.md)。
</div>
...
查看全部章节、案例、附录、模板和维护页面。
</div>

<div class="resource-card" markdown="1">
**[真实应用案例](case-studies.md)**

按角色拆分的案例入口，以及技术演进案例的总入口。
</div>
...
从教学用手写 `traceparent` 过渡到 Python / Node.js SDK 的 `inject` / `extract`。
</div>
...
第 0-14 章覆盖对话、prompt、工作流、评估、RAG、skills、agent、记忆、OpenClaw、开源模型、前沿发展、安全治理和 30 天实践计划。
</div>

<div class="route-card" markdown="1">
**案例与复盘**

角色案例、行业工作坊案例、团队落地案例、模型选型案例、安全事故复盘和技术演进案例。
</div>

<div class="route-card" markdown="1">
**教学与组织落地**

读书会方案、教学材料包、课堂工作纸、团队路线图、AI 安全与模型选型工作坊、30 天试点跟踪表和试跑反馈包。
</div>

<div class="route-card" markdown="1">
**速查与维护**

速查讲义、常见误区、Prompt 调试、任务选择、资源引用、季度复核、发布检查和自动化维护。
</div>
</div>
