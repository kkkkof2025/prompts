...
| 会议纪要、内容排期、跨渠道活动执行 | [运营案例](operations.md) | 第 3-4 章、第 13 章 |
| 竞品分析、需求评审、AI 功能最小实验 | [产品案例](product.md) | 第 4-6 章、第 5 章 |
| 修 Bug、补测试、发布风险审查 | [工程案例](engineering.md) | 第 4-8 章、第 13 章 |
| 团队规范、项目复盘、AI 试点责任矩阵 | [管理者案例](management.md) | 第 5-6 章、第 13-14 章 |
| 作品集、面试、接单与职业转型 | [职业发展案例](career-development.md) | 第 14-15 章 |
...
| 高 | 管理者案例、安全复盘、前沿技术演进案例、Agent Trace 生产事故复盘长案例、职业发展中涉及客户交付和公开承诺的部分 | 重点练习人工确认、权限和责任边界 |
...
| 运营 | [会议纪要、内容排期、跨渠道活动执行](operations.md) | 信息整理、待办拆解、执行检查、渠道复盘 |
| 产品 | [竞品分析、需求评审、AI 功能最小实验](product.md) | 决策问题、事实与推测分离、实验指标 |
| 工程 | [修 Bug、补测试、发布风险审查](engineering.md) | 复现、修改范围、验证闭环、发布闸门 |
| 管理者 | [AI 使用规范、项目复盘、试点责任矩阵](management.md) | 风险边界、组织流程、责任分工、试点治理 |
| 职业发展 | [作品集、面试、接单与转型](career-development.md) | 项目证据、作品集、面试表达、服务边界 |
...
| 第 15 章 | 职业发展案例、端到端实战项目指南、AI 求职资源大全 |
