...
| Runtime Log | [Runtime Log](appendix-glossary.md#runtime-log) | [Observability / Tracing：智能体可观测性](observability-tracing-agent-workflows.md)、[多语言 Trace Context 传播样例](../examples/trace-observability/trace-context-multilang.md) | [多语言运行日志回放样例](../examples/trace-observability/trace-runtime-log-replay.md)、[Agent Trace 可观测性样例](../examples/trace-observability/index.md) | 把运行日志误当成业务事实源，或把完整输出直接塞进去 |
